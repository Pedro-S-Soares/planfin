defmodule PlanfinBackendWeb.UserAuth do
  ...
  @remember_me_cookie "_planfin_backend_web_user_remember_me"
  @remember_me_options [
    sign: true,
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      PlanfinBackendWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
